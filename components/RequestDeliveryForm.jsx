...
const RequestDeliveryForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            await deliveryService.createTemporaryDeliveryRequest(data);

            // Redirect to quotation and payment page if success on completing forms
            router.push('/quotation');
        } catch (error) {
            console.error("Error in submitting delivery request:", error);
            setResponseMessage("Failed to create delivery request.");
        }
    };
